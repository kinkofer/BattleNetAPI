...
public class AuthenticationModelController {
    public static let shared = AuthenticationModelController()
    private init() { }
    
    
    public func getClientAccessToken(region: APIRegion = Current.region, clientID: String, clientSecret: String, completion: @escaping (_ result: Result<Access, HTTPError>) -> Void) {
    ...
    public func getUserAccessToken(region: APIRegion = Current.region, clientID: String, clientSecret: String, code: String, redirectURL: String, completion: @escaping (_ result: Result<Access, HTTPError>) -> Void) {
    ...
    public func validateClientAccessToken(_ token: String, region: APIRegion = Current.region, completion: @escaping (_ result: Result<ClientToken, HTTPError>) -> Void) {
    ...
    public func validateUserAccessToken(_ token: String, region: APIRegion = Current.region, completion: @escaping (_ result: Result<UserToken, HTTPError>) -> Void) {
    ...
    */
    public func sendToOAuth(region: APIRegion = Current.region, clientID: String, scope: Scope, redirectURL: String) {
    ...
    public func getOAuthURL(region: APIRegion = Current.region, clientID: String, scope: Scope, redirectURL: String) -> URL? {
