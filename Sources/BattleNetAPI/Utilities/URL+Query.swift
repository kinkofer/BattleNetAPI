...
extension URL {
    /// Adds or updates a key-value parameter to the end of the url string, like "key=value", or removes the parameter if the value is nil.
    ...
    /// Adds or updates key-value parameters to the end of the url string, like "key=value", removing any parameters set to nil values
